...
public class ClassesRecord extends javax.swing.JFrame {
Connection con=null;
ResultSet rs=null;
 ...
 private void Get_Data(){
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(ClassesRecord.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new ClassesRecord().setVisible(true);
            }
        });
    }
